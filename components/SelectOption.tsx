...
const AnimatedSelect: React.FC<AnimatedSelectProps> = ({ options, onChange }) => {
        ...
        <div className="relative inline-block text-left bg-secondary border border-secondary rounded-full ">
            <div>
                ...
                >
                    ...
                    <BsChevronCompactDown size={25} className={`w-4 h-4 ml-2 transition-transform transform ${isOpen ? "rotate-180" : ""
                        }`} />
                </button>
            </div>
